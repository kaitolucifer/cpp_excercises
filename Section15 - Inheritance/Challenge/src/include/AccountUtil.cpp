...
void withdraw(std::vector<Account> &accounts, double amount)
{
    ...
    for (auto &acc : accounts)
    {
        if (acc.withdraw(amount))
            ...
            std::cout << "Faield Withdrawal of " << amount << " from " << acc << std::endl;
    }
}
...
// Deposits supplied amount to each Savings Account objects in the vector
...
// Withdraw amount from each Savings Account objects in the vector
...
// Deposits supplied amount to each Trust Account objects in the vector
...
// Withdraw amount from each Trust Account objects in the vector
